...
%          Moment Uncertainty"
%
%   Description: Find the worst case probability given certain ambiguity 
%                set on the moments associated with initial measure using 
%                a sum-of-squares program.
%
...
ambiguity = [0; 0.001; 0.002; 0.005; 0.008];
len_amb = length(ambiguity);

mean_moments = [x0; 0.05+x0(1)*x0(1); 0.01+x0(2)*x0(2)];
...
r0 = [0.81; 0.84];
g = +0.005 - (1.*[X(1);X(2)]-r0)'*(1.*[X(1);X(2)]-r0);
...
for ambk = 1:len_amb
    ...
    ubalpha = (1+test_ambiguity)*mean_moments; 
    lbalpha = (1-test_ambiguity)*mean_moments; 
...
% save to file
filename = 'data/ex2_sos_ambiguity_results.mat';
