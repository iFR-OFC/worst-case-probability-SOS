...
for kd = 1:degree_len
    ...
    muk = casos.PS.sym('muk', monomials(X(1:2),0:degv/2), 'dual');        % measure to get the probability
    ...
    g_lin = [liouville_eq;                  % dynamics constraint
             ...
             % moment constraints
             mu_init.evaluate(X(1))-x0(1);  
             mu_init.evaluate(X(2))-x0(2);  
...
% save to file
filename = 'data/ex2_meas_nominal_results.mat';
